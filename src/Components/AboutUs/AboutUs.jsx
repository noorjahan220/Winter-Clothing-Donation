        ...
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row items-center space-y-8 md:space-y-0">
            ...
            <div className="relative md:w-1/2 flex justify-center">
              <div className="relative">
                ...
                <img
                  ...
                  alt="Our Vision"
                  className="absolute top-20 left-32 w-3/4 h-auto max-w-[300px] rounded-lg shadow-md border-4 border-gray-100"
                />
              </div>
            </div>
            ...
            <div className="md:w-1/2 text-center md:text-left">
              ...
              <a
                href="#readmore"
                className="btn bg-emerald-700 hover:bg-emerald-800 text-white mt-6"
              >
                Learn More
              </a>
            </div>
